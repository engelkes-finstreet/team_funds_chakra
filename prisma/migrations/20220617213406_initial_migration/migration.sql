...
-- CreateTable
CREATE TABLE "ConfirmAdminUserToken" (
...
-- CreateTable
CREATE TABLE "ResetAdminUserPasswordToken" (
    "adminId" TEXT NOT NULL,
    "token" TEXT NOT NULL,
    "expiresAt" TIMESTAMP(3) NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ConfirmUserToken_userId_key" ON "ConfirmUserToken"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "ConfirmUserToken_token_key" ON "ConfirmUserToken"("token");

-- CreateIndex
CREATE UNIQUE INDEX "ResetUserPasswordToken_userId_key" ON "ResetUserPasswordToken"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "ResetUserPasswordToken_token_key" ON "ResetUserPasswordToken"("token");

-- CreateIndex
CREATE UNIQUE INDEX "ConfirmAdminUserToken_adminId_key" ON "ConfirmAdminUserToken"("adminId");

-- CreateIndex
CREATE UNIQUE INDEX "ConfirmAdminUserToken_token_key" ON "ConfirmAdminUserToken"("token");

-- CreateIndex
CREATE UNIQUE INDEX "ResetAdminUserPasswordToken_adminId_key" ON "ResetAdminUserPasswordToken"("adminId");

-- CreateIndex
CREATE UNIQUE INDEX "ResetAdminUserPasswordToken_token_key" ON "ResetAdminUserPasswordToken"("token");
...
-- AddForeignKey
ALTER TABLE "ConfirmUserToken" ADD CONSTRAINT "ConfirmUserToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ResetUserPasswordToken" ADD CONSTRAINT "ResetUserPasswordToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConfirmAdminUserToken" ADD CONSTRAINT "ConfirmAdminUserToken_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "AdminUser"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ResetAdminUserPasswordToken" ADD CONSTRAINT "ResetAdminUserPasswordToken_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "AdminUser"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
